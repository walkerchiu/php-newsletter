...
class ArticleFormRequest extends FormRequest
{
    ...
    {
        $rules = [
            'setting_id' => ['required','string','exists:'.config('wk-core.table.newsletter.settings').',id'],
            'serial'     => '',
            'style'      => '',
        ...
        if (
            ...
            $rules = array_merge($rules, ['id' => ['required','string','exists:'.config('wk-core.table.newsletter.articles').',id']]);
        }
